(defproject org.clojure.clr/tools.analyzer "0.5.2-SNAPSHOT"
  :description "Port of clojure.org/tools.analyzer to ClojureCLR"
  :url "https://github.com/clojure/clr.tools.analyzer"
